      ...
      SELECT
        ...
        jsonb_agg(
          jsonb_build_object(
            ...
            -- is_verified. This query never selected any of the three before,
            -- so the archives row could not show a badge for ANY counterpart.
            'isVerified', COALESCE(u.is_badged, r.is_verified, b.is_verified, FALSE)
          )
        ) AS users
      FROM (
